...
val appTranslators = arrayOf(
    ...
    TranslatorItem(arrayOf("ar"), "Mohammed Lahboub", github = "Mohammed-Lahboub"),
    ...
    TranslatorItem(arrayOf("haw", "cpe"), "En Oh", weblate = "helmsmansulu"),
    ...
    TranslatorItem(arrayOf("pt"), "tiagossa1", weblate = "tiagossa1"),
    ...
    TranslatorItem(arrayOf("ur"), "haseebwt", weblate = "haseebwt"),
