...
public class RequiredApiKeyMissingHelp {

    public static void show(Activity activity) {
        View view = LayoutInflater
                .from(activity)
                .inflate(R.layout.dialog_api_key_required_missing_help, null, false);
        initWidget(
                activity,
                view,
                new MaterialAlertDialogBuilder(activity)
                        .setTitle(R.string.weather_api_key_required_missing_message)
                        .setView(view)
                        .show()
        );
    }
