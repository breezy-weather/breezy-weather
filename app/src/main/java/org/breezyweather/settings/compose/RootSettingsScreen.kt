    ...
    PreferenceScreen(paddingValues = paddingValues) {
        clickablePreferenceItem(R.string.settings_background_updates) { id ->
            PreferenceView(
                ...
                onClick = { onNavigateTo(SettingsScreenRouter.BackgroundUpdates.route) }
            )
        }
        clickablePreferenceItem(R.string.settings_appearance) { id ->
            PreferenceView(
                ...
                onClick = { onNavigateTo(SettingsScreenRouter.Appearance.route) }
            )
        }
        clickablePreferenceItem(R.string.settings_main) { id ->
            PreferenceView(
                ...
                onClick = { onNavigateTo(SettingsScreenRouter.MainScreen.route) }
            )
        }
        clickablePreferenceItem(R.string.settings_notifications) { id ->
            PreferenceView(
                ...
                onClick = { onNavigateTo(SettingsScreenRouter.Notifications.route) }
            )
        }
        clickablePreferenceItem(R.string.settings_widgets) { id ->
            PreferenceView(
                ...
                onClick = { onNavigateTo(SettingsScreenRouter.Widgets.route) }
            )
        }
        clickablePreferenceItem(R.string.settings_location) { id ->
            PreferenceView(
                ...
                onClick = { onNavigateTo(SettingsScreenRouter.Location.route) }
            )
        }
        clickablePreferenceItem(R.string.settings_weather_sources) { id ->
            PreferenceView(
                ...
                onClick = { onNavigateTo(SettingsScreenRouter.WeatherProviders.route) }
            )
        }
        clickablePreferenceItem(R.string.settings_debug) { id ->
            PreferenceView(
                ...
                onClick = { onNavigateTo(SettingsScreenRouter.Debug.route) }
            )
        }
