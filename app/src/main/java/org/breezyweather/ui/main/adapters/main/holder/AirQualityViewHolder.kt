...
class AirQualityViewHolder(parent: ViewGroup) : AbstractMainCardViewHolder(
    ...
    override fun onBindView(
        ...
        titleView.setText(R.string.air_quality)
        ...
        location.weather!!.validAirQuality?.let { airQuality ->
            ...
            if (itemAnimationEnabled) {
                aqiProgress.apply {
                    progress = 0f
                    aqiValueView.text = Utils.formatInt(context, 0)
                    setProgressColor(
                ...
                aqiProgress.apply {
                    ...
                    aqiValueView.text = Utils.formatInt(context, mAqiIndex)
            ...
            talkBackBuilder
                ...
                .append(Utils.formatInt(context, mAqiIndex))
        ...
        if (itemAnimationEnabled && mEnable) {
            mLocation!!.weather!!.validAirQuality?.let { airQuality ->
                ...
                aqiNumber.addUpdateListener { animation: ValueAnimator ->
                    ...
                    aqiValueView.text = Utils.formatInt(context, aqiProgress.progress.roundToInt())
                }
