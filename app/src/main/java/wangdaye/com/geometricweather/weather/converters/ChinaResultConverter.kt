...
import wangdaye.com.geometricweather.weather.json.china.ChinaForecastDaily
import wangdaye.com.geometricweather.weather.json.china.ChinaForecastHourly
...
private fun getAlertList(result: ChinaForecastResult): List<Alert> {
    ...
    result.alerts.forEach { alert ->
        alertList.add(
            Alert(
                alert.pubTime?.time ?: System.currentTimeMillis(), // TODO: Avoid having the same ID for two different alerts happening at the same time
                alert.pubTime,
                null,
                alert.title,
                alert.detail,
