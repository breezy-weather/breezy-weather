...
public class WidgetDayWeekAlarmService extends GeoAlarmService {
    // data
    private static final int PENDING_INTENT_CODE = 13;
    public static final int ALARM_CODE = 3;

    /** <br> life cycle. */

    public WidgetDayWeekAlarmService() {
        super("WidgetDayWeekAlarmService");
    }

    public WidgetDayWeekAlarmService(String name) {
        super(name);
    }
