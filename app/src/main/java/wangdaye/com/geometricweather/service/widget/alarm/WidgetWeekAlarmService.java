...
public class WidgetWeekAlarmService extends GeoAlarmService {
    // data
    ...
    public WidgetWeekAlarmService() {
        super("WidgetWeekAlarmService");
    }

    public WidgetWeekAlarmService(String name) {
        super(name);
    }
