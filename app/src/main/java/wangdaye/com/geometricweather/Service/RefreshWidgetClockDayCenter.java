...
public class RefreshWidgetClockDayCenter extends Service
    ...
    // handler
    private SafeHandler<RefreshWidgetClockDayCenter> safeHandler;

    //TAG
//    private final String TAG = "RefreshWidgetClockDayCenter";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        this.locationName = sharedPreferences.getString(
                getString(R.string.key_location),
                getString(R.string.local));

        RefreshWidgetClockDayCenter.refreshUIFromLocalData(this, isDay);
        this.refreshWidget();
    ...
    public static void refreshUIFromInternet(Context context, WeatherInfoToShow info, boolean isDay) {
        ...
        if(hideRefreshTime) {
            views.setViewVisibility(R.id.widget_clock_day_center_time, View.GONE);
        } else {
            views.setViewVisibility(R.id.widget_clock_day_center_time, View.VISIBLE);
        }
        if(blackText) {
    ...
    public static void refreshUIFromLocalData(Context context, boolean isDay) {
        ...
        String weatherKind = sharedPreferences.getString(context.getString(R.string.key_weather_kind_today), "阴");
        String dateText = sharedPreferences.getString(context.getString(R.string.key_week_2), context.getString(R.string.wait_refresh));
        ...
        String temperatureText = sharedPreferences.getString(context.getString(R.string.key_temperature_today), context.getString(R.string.ellipsis));
