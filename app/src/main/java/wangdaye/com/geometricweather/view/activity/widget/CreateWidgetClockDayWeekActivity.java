...
public class CreateWidgetClockDayWeekActivity extends GeoActivity
    ...
    private void refreshWidgetView() {
        ...
        int[] imageId = WeatherHelper.getWeatherIcon(weather.live.weather, isDay);
        ...
        for (int i = 0; i < 5; i ++) {
            ...
            int[] imageIds = WeatherHelper.getWeatherIcon(
                    isDay ? weather.dailyList.get(i).weathers[0] : weather.dailyList.get(i).weathers[1],
                    isDay);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.activity_create_widget_clock_day_week_doneButton:
                ...
                Intent service = new Intent(this, WidgetClockDayWeekAlarmService.class);
