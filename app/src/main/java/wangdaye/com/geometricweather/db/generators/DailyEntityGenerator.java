...
public class DailyEntityGenerator {
    ...
    public static DailyEntity generate(String cityId, WeatherSource source, Daily daily) {
        ...
        if (daily.day() != null) {
            ...
            if (daily.day().getTemperature() != null) {
            ...
            if (daily.day().getPrecipitation() != null) {
            ...
            if (daily.day().getPrecipitationProbability() != null) {
            ...
            if (daily.day().getPrecipitationDuration() != null) {
        ...
        if (daily.night() != null) {
            ...
            if (daily.night().getTemperature() != null) {
            ...
            if (daily.night().getPrecipitation() != null) {
            ...
            if (daily.night().getPrecipitationProbability() != null) {
            ...
            if (daily.night().getPrecipitationDuration() != null) {
