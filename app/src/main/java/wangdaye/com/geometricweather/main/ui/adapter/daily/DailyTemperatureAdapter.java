...
public class DailyTemperatureAdapter extends wangdaye.com.geometricweather.ui.widget.trend.adapter.DailyTemperatureAdapter {
    ...
    public DailyTemperatureAdapter(GeoActivity activity, TrendRecyclerView parent, float cardMarginsVertical, float cardMarginsHorizontal, int itemCountPerLine, float itemHeight, @NonNull Weather weather, int[] themeColors, ResourceProvider provider, MainColorPicker picker, TemperatureUnit unit) {
