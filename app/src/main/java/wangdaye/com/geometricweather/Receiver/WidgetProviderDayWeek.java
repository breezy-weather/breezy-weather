...
/**
 * Widget provider of the widget [day + week].
 * */

public class WidgetProviderDayWeek extends AppWidgetProvider {
    // widget
    private PendingIntent pendingIntent = null;

    // TAG
//    private final String TAG = "WidgetProviderDayWeek";
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        Intent alarmIntent = new Intent(context, RefreshWidgetDayWeek.class);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        switch (action) {
            case "com.geometricweather.receiver.REFRESH_WIDGET":
                // update
                Intent intentRefresh = new Intent(context, RefreshWidgetDayWeek.class);
