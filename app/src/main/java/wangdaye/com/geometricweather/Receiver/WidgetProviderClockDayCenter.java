...
public class WidgetProviderClockDayCenter extends AppWidgetProvider {
    ...
    // TAG
//    private final String TAG = "WidgetProviderClockDayCenter";
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        Intent alarmIntent = new Intent(context, RefreshWidgetClockDayCenter.class);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        switch (action) {
            case "com.geometricweather.receiver.REFRESH_WIDGET":
                // update
                Intent intentRefresh = new Intent(context, RefreshWidgetClockDayCenter.class);
